...
extern int cgo_on_encoded_video_frame(AGORA_HANDLE agora_video_encoded_frame_observer, const char* channelId, const char* uid, const uint8_t* image_buffer, size_t length,
