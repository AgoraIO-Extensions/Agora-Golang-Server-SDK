...
extern int cgo_on_record_audio_frame(AGORA_HANDLE agora_local_user /* raw pointer */,const char* channelId, const audio_frame* frame);
extern int cgo_on_playback_audio_frame(AGORA_HANDLE agora_local_user, const char* channelId, const audio_frame* frame);
extern int cgo_on_mixed_audio_frame(AGORA_HANDLE agora_local_user, const char* channelId, const audio_frame* frame);
extern int cgo_on_ear_monitoring_audio_frame(AGORA_HANDLE agora_local_user, const audio_frame* frame);
...
extern int cgo_on_get_audio_frame_position(AGORA_HANDLE agora_local_user);
extern audio_params cgo_on_get_playback_audio_frame_param(AGORA_HANDLE agora_local_user);
